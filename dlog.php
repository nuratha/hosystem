...
<!-- CONTENT GOES HERE -->
		<main class="p-6">
			<section class="p-6 grid grid-cols-2 gap-4 place-items-center">
			    <div class="p-6 grid grid-cols-1 h-full bg-slate-700">
                    ...
                    <div class="self-center">
                        ...
                        <p class="text-justify">
                            Staff in Hosystem are able to monitor their appointment records and view their patient's records, as well as access and add more available hospitals to the system.
                        </p>
                        
                        <br>
                        
                        <!-- NAVIGATION -->
                        <label class="underline text-white hover:text-accent active:text-secondary"><a href="./dsign.php">
                ...
                <!-- column 2 -->
                <!-- Login fx here-->
                <div><form action="includes/dlogin.inc.php" method="post">
                    <!-- Email input -->
                    <div>
                        <label class="label">
